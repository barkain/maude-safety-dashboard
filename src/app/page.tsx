...
import { getTopManufacturers, getTopDevices } from '@/lib/firestore'
...
// Aggregate headline numbers (derived from mock data / real Firestore on production)
const HEADLINE_STATS = [
  { label: 'Total Events (2024-25)', value: '600K+',   sub: 'MAUDE reports analysed',   accent: 'blue'   },
  { label: 'Manufacturers Tracked',  value: '4,200+',  sub: 'Unique reporting entities', accent: 'green'  },
  { label: 'Device Types',           value: '18,000+', sub: 'Across all product codes',  accent: 'default'},
  { label: 'Recalls Logged',         value: '1,100+',  sub: '2024-2025 FDA recall data', accent: 'orange' },
] as const
      ...
      <section className="bg-gradient-to-br from-brand-700 via-brand-600 to-brand-500 px-4 py-16 text-white sm:px-6 sm:py-20">
        <div className="mx-auto max-w-3xl text-center">
          ...
          <p className="mt-4 text-base text-brand-100 sm:text-lg">
            ...
            manufacturers, and track recall history — all in one place.
          </p>
          ...
          <p className="mt-3 text-xs text-brand-200">
            Try: &ldquo;insulin pump&rdquo;, &ldquo;Medtronic&rdquo;, &ldquo;cardiac monitor&rdquo;
          </p>
        </div>
      </section>
